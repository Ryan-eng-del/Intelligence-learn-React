            ...
            o(e, null, [
              ...
              },
              {
                ...
                value: function (t, n) {
                  if (!t) throw new Error('PrismPlayer Error: vid should not be null!')
                  return a.stringify(
                    i('GET&' + e.aliyunEncodeURI('/') + '&' + e.aliyunEncodeURI(e.makeUTF8sort(t, '=', '&')), n + '&')
                  )
                }
              }
            ]),
          ...
          return (
            i(e, [
              ...
              },
              {
                ...
                value: function () {
                  if (
                    (this._state == a.VODSTATE.START || this._state == a.VODSTATE.FAILURE || -1 == this._curIndex) &&
                    -1 != this._curIndex
                  ) {
              ...
              },
              {
                ...
                value: function (e, t, n, r, o) {
                  if (!(t && n && r && o))
                    return (
                      console.log('accessKeyId、ccessKeySecret、securityToken and expiration should not be empty.'), !1
                    )
                  this._ut = 'oss'
                  var i = e
                  this.init(t, n, r, o),
                ...
                value: function (e) {
                  ...
                  if (((e.retry = t), n.onUploadstarted && !t))
                    try {
                      ...
                      r && r.state != a.UPLOADSTATE.UPLOADING && ((e.checkpoint = r), (e.videoId = r.videoId)),
                        n.onUploadstarted(e)
                    } catch (e) {
                      console.log(e)
                    }
              ...
              },
              {
                ...
                value: function (e, t, n) {
                  ...
                  var r = t.checkpoint,
                    o = 0
                  r && ((e.checkpoint = r), this._saveCheckoutpoint(e, r, a.UPLOADSTATE.UPLOADING), (o = r.uploadId)),
                    (this._retryCount = 0)
                ...
                value: function (e, t) {
                  ...
                  t.headers && (o.headers = t.headers),
                    ...
                    this.oss
                      ...
                      .catch(function (e) {
                        n.oss.cancel &&
                          (n.oss && n.oss.isCancel() ? console.log('oss is cancel as error') : n.oss.cancel()),
                          n._error(e)
                      })
                }
              },
    ...
    ;(function (e) {
      ...
      ;(i.prototype.slice = function (e, t) {
        ...
        (i.prototype.readUInt32LE = function (e, t) {
          return (
            t || D(e, 4, this.length), (this[e] | (this[e + 1] << 8) | (this[e + 2] << 16)) + 16777216 * this[e + 3]
          )
        }),
        (i.prototype.readUInt32BE = function (e, t) {
          return (
            t || D(e, 4, this.length), 16777216 * this[e] + ((this[e + 1] << 16) | (this[e + 2] << 8) | this[e + 3])
          )
        }),
  ...
  function (e, t, n) {
    ...
    function u(e, t, n) {
      for (var r, o = [], i = t; i < n; i += 3)
        (r = ((e[i] << 16) & 16711680) + ((e[i + 1] << 8) & 65280) + (255 & e[i + 2])), o.push(s(r))
      return o.join('')
    }
    function c(e) {
      ...
      return (
        1 === r
          ...
          : 2 === r &&
            ((t = (e[n - 2] << 8) + e[n - 1]), o.push(l[t >> 10] + l[(t >> 4) & 63] + l[(t << 2) & 63] + '=')),
        o.join('')
      )
    }
      ...
      !(function () {
        ...
        a.HMAC = r.extend({
          init: function (e, t) {
            ...
            for (
              var o = (this._oKey = t.clone()), a = (this._iKey = t.clone()), s = o.words, u = a.words, c = 0;
              c < n;
              c++
            )
            ...
            },
            {
              ...
              value: function (t, n, r) {
                ...
                var p =
                    ...
                    '&Signature=' +
                    y.default.aliyunEncodeURI(y.default.makeChangeSiga(d, t.accessKeySecret)),
