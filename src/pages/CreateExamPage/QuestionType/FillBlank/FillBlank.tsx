  ...
  return (
    <>
      ...
      <Form>
        ...
        <Switch checkedChildren="客观" unCheckedChildren="主观" checked={question.objective}
        ...
        {/* </Form.Item> */}
        <Button onClick={addBlank} type="primary">添加更多空位</Button>&nbsp;&nbsp;&nbsp;
        <Button onClick={delBlank} type="primary" danger>删除空位</Button>&nbsp;&nbsp;&nbsp;
        *请确保空位与题干中的数量匹配
