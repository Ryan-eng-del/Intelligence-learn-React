    ...
    <>
      <BasicInformationWrapper>
        ...
        >
          ...
          <Descriptions.Item label="个性签名" span={2}>未设置</Descriptions.Item>
          <Descriptions.Item label="注册时间"  span={2}>2018-04-24 18:00:00</Descriptions.Item>
          <Descriptions.Item label="企业">厂东技术师范大学</Descriptions.Item>
          <Descriptions.Item label="部门">计算机科学学院</Descriptions.Item>
          <Descriptions.Item label="编号"  span={2}>20200XXXXXXXX</Descriptions.Item>
        </Descriptions>
      </BasicInformationWrapper>
