...
export const ContactModal:React.FC<{
  ...
  const [data,setData] = useState([
    ...
    {id:"dasa3sddsa",isMe:false,msg:"左边场文字左边场文字左边场文字左边场文字左边场文字左边场文字左边场文字左边场文字左边场文字"},
    {id:"dasa4sddsa",isMe:true,msg:"右边长文字右边长文字右边长文字右边长文字右边长文字右边长文字右边长文字右边长文字右边长文字"},
  ...
  >
    <div style={{maxHeight:"200px", overflow:"scroll"}} id="test" >
      {data.map(i=><ChatBubble right={i.isMe} msg={i.msg} key={i.id}/>)}
    </div>
